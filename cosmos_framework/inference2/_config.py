...
ROOT_DIR = Path(__file__).parents[1].absolute()  # cosmos_framework/ (inference2 is one level below root)
PACKAGE_DIR = ROOT_DIR / "inference2"
CONFIG_DIR = PACKAGE_DIR / "configs"


def is_rank0() -> bool:
    """Rank-0 check, inlined so inference2 doesn't import from cosmos_framework.inference
    (cf. inference.common.init.is_rank0)."""
