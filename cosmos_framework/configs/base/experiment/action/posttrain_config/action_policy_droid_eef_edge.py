...
action_policy_droid_eef_edge = LazyDict(
    dict(
        ...
        action_policy=dict(
            schema_version=1,
            profile_id="droid_panda_link8_stage1_15hz_c32",
            robot="droid",
            ...
            conditioning=dict(
                ...
                history_rows=0,
                source="none",
                timing="32 future panda_link8 poses are encoded as SE(3) deltas anchored at the current pose",
            ),
            decoder_anchor=dict(kind="current_eef_pose", frame="panda_link8", quaternion_order="xyzw"),
            observation=dict(
            ...
            datasets=(
                dict(
                    ...
                    source_frame="panda_link8",
                    source_gripper_index=9,
                    source_target_offset=1,
                    description="DROID panda_link8 flange trajectories filtered by Fx4 and resampled at 15 Hz.",
