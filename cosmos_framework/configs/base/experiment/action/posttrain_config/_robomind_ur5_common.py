...
def build_robomind_ur5_experiment(*, name: str, which_arm: str, root_env: str) -> LazyDict:
        ...
        dict(
            ...
            dataloader_train=L(PackingDataLoader)(
                ...
                dataloader=L(RankPartitionedDataLoader)(
                    ...
                    # shuffled, sequential-within-episode (decorrelates the per-step global batch to
                    # keep grad-norm stable; see action_sft_dataset.py).
                    datasets=dict(
                        robomind_ur5=dict(
                            ratio=1,
    ...
    # Uncap the packed-sequence length so the full vision sequence is processed per step.
