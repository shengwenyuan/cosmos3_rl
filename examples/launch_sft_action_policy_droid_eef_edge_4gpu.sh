...
# One-node, 4-GPU Cosmos3-Edge DROID Fx4 EEF Stage-1 training.

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
TOML_FILE="$SCRIPT_DIR/toml/sft_config/action_policy_droid_eef_edge_4gpu.toml"
...
export HF_HOME IMAGINAIRE_OUTPUT_ROOT NNODES NPROC_PER_NODE OUTPUT_ROOT PYTHON_BIN
